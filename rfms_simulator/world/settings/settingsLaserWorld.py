...
class LaserTradGridHorizontal(object):
    '''
...
class LaserTradGridVertical(object):
    ...
    def __init__(self):
        ...
        #! ALSO CHECK THE FREE SPACE AVAILABLE!
        #* SET the DEFAULT Obstacles (Pods)
        self.OBSTACLES = [(0, 2), (0, 3), (0, 4), (0, 5),
                          (2, 1), (2, 2), (2, 3), (2, 4), (2, 5),
                          (3, 1), (3, 2), (3, 3), (3, 4), (3, 5),
                          (5, 1), (5, 2), (5, 3), (5, 5), (5, 4),
                          (6, 1), (6, 2),  (6, 4), (6, 5), (6, 3)]
...
class BigWarehouseGrid(object):
    '''
    Class responsible to save the World Variables for
    the simulation based at an 100x100 Traditional Warehouse Layout
